...
public class AuthenticateCommand extends Command {
	...
	public AuthenticateCommand(String commandId, String commandKey, String commandArgs) {
		super(commandId, commandKey, commandArgs);
	}

	public static AuthenticateCommand buildCommand(String commandId, String commandKey, String commandArgs) {
	...
	public Response executeImpl() throws AuthMethodNotSupportedException {
		...
		AuthMethodNotSupportedException e = new AuthMethodNotSupportedException(commandId, commandKey, commandArgs, method);
