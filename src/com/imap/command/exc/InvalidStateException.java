...
public class InvalidStateException extends CommandException {
	...
	public InvalidStateException(String id, String key, String args,
			EConnectionState currentState) {
		super(id, key, args);
	...
	public String toString() {
		return this.getClass().getName() + ".  Invalid state for id '" 
		+ getId() + "', key '" + getKey() + "' args '" + getArgs() 
