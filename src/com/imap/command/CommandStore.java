...
public class CommandStore extends HashMap<String, Method> {
	...
	private void initCommands() {
		try {
			this.put(ECommand.CAPABILITY.getValue(), CapabilityCommand.class.getMethod("buildCommand", String.class, String.class, String.class));
			this.put(ECommand.LOGIN.getValue(), LoginCommand.class.getMethod("buildCommand", String.class, String.class, String.class));
	...
	public Command getCommandForInput(String in) throws CommandException, IllegalArgumentException, IllegalAccessException,
